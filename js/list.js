...
var game = {
  ...
  set4: {
    ...
    power: power_bronze,
    view: {
      price: intel_i5.price + gpu_1060.price + ram_8.price + ssd_500.price + hdd_1T.price + main_H310M.price + case_basic.price + power_bronze.price,
      cpu: intel_i5.name,
      gpu: gpu_1060.name,
      ram: ram_8.name,
      ssd: ssd_500.name,
  ...
  set5: {
    ...
    power: power_gold,
    view: {
      price: intel_i7.price + gpu_2080ti.price + ram_16.price + ssd_500.price + hdd_3T.price + main_B360M.price + case_custom.price + power_gold.price,
      cpu: intel_i7.name,
      gpu: gpu_2080ti.name,
      ram: ram_16.name,
      ssd: ssd_500.name,
...
var design = {
  set1: {
    ...
    power: power_bronze,
    view: {
      price: intel_i5.price + gpu_inner.price + ram_8.price + ssd_500.price + hdd_no.price + main_H310M.price + case_basic.price + power_bronze.price,
      cpu: intel_i5.name,
      gpu: gpu_inner.name,
      ram: ram_8.name,
      ssd: ssd_500.name,
  ...
  set2: {
    ...
    power: power_bronze,
    view: {
      price: intel_i7.price + gpu_1060.price + ram_16.price + ssd_512.price + hdd_1T.price + main_B360M.price + case_basic.price + power_bronze.price,
      cpu: intel_i7.name,
      gpu: gpu_1060.name,
      ram: ram_16.name,
      ssd: ssd_512.name,
  ...
  set3: {
    ...
    power: power_bronze,
    view: {
      price: intel_i7.price + gpu_1060.price + ram_32.price + ssd_1024.price + hdd_3T.price + main_B360M.price + case_basic.price + power_bronze.price,
      cpu: intel_i7.name,
      gpu: gpu_1060.name,
      ram: ram_32.name,
      ssd: ssd_1024.name,
  ...
  set4: {
    ...
    power: power_bronze,
    view: {
      price: intel_i5.price + gpu_1060.price + ram_16.price + ssd_500.price + hdd_1T.price + main_H310M.price + case_basic.price + power_bronze.price,
      cpu: intel_i5.name,
      gpu: gpu_1060.name,
      ram: ram_16.name,
      ssd: ssd_500.name,
...
var dev = {
  set1: {
    ...
    power: power_bronze,
    view: {
      price: intel_i5.price + gpu_inner.price + ram_8.price + ssd_250.price + hdd_no.price + main_H310M.price + case_basic.price + power_bronze.price,
      cpu: intel_i5.name,
      gpu: gpu_inner.name,
      ram: ram_8.name,
      ssd: ssd_250.name,
  ...
  set2: {
    ...
    power: power_bronze,
    view: {
      price: intel_i7.price + gpu_inner.price + ram_8.price + ssd_500.price + hdd_no.price + main_B360M.price + case_basic.price + power_bronze.price,
      cpu: intel_i7.name,
      gpu: gpu_inner.name,
      ram: ram_8.name,
      ssd: ssd_500.name,
  ...
  set3: {
    ...
    power: power_bronze,
    view: {
      price: intel_i9.price + gpu_inner.price + ram_16.price + ssd_500.price + hdd_1T.price + main_B360M.price + case_basic.price + power_bronze.price,
      cpu: intel_i9.name,
      gpu: gpu_inner.name,
      ram: ram_16.name,
      ssd: ssd_500.name,
  ...
  set4: {
    ...
    power: power_bronze,
    view: {
      price: intel_i7.price + gpu_inner.price + ram_16.price + ssd_500.price + hdd_1T.price + main_B360M.price + case_basic.price + power_bronze.price,
      cpu: intel_i7.name,
      gpu: gpu_inner.name,
      ram: ram_16.name,
      ssd: ssd_500.name,
...
var office = {
  set1: {
    ...
    power: power_bronze,
    view: {
      price: intelCeleron.price + gpu_inner.price + ram_4.price + ssd_120.price + hdd_no.price + main_H310M.price + case_basic.price + power_bronze.price,
  ...
  set2: {
    ...
    power: power_bronze,
    view: {
      price: intel_i3.price + gpu_inner.price + ram_8.price + ssd_120.price + hdd_1T.price + main_H310M.price + case_basic.price + power_bronze.price,
      cpu: intel_i3.name,
      gpu: gpu_inner.name,
      ram: ram_8.name,
      ssd: ssd_120.name,
  ...
  set3: {
    ...
    power: power_bronze,
    view: {
      price: intel_i5.price + gpu_inner.price + ram_8.price + ssd_120.price + hdd_1T.price + main_H310M.price + case_basic.price + power_bronze.price,
      cpu: intel_i5.name,
      gpu: gpu_inner.name,
      ram: ram_8.name,
      ssd: ssd_120.name,
  ...
  set4: {
    ...
    power: power_bronze,
    view: {
      price: intel_i7.price + gpu_inner.price + ram_8.price + ssd_120.price + hdd_3T.price + main_B360M.price + case_basic.price + power_bronze.price,
      cpu: intel_i7.name,
      gpu: gpu_inner.name,
      ram: ram_8.name,
      ssd: ssd_120.name,
...
//
// })
// $('.Purpose_content').change(function() {
//   if ($('.Purpose_content option:selected').val() == 'Game') {
//     makeItem(game);
//   } else if ($('.Purpose_content option:selected').val() == 'Dev') {
//     makeItem(dev);
